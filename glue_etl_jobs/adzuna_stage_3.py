...
path = f"s3a://naya-project-job-ads/data/stages/adzuna/stage_2/{year}/{month}/{day}/"
    
df = spark.read.parquet(path)

# --- Transformations ---

# 1. Break up created into parts
