#!/usr/bin/env python3
"""
Clicks: Generate click data for job advertisements
"""
...
def main():
    ...
    print(f"Loaded {job_count} jobs for click generation")
    ...
    click_count = final_clicks.count()
    print(f"✅ Click data written to {output_path}. Total clicks: {click_count}")
    spark.stop()
