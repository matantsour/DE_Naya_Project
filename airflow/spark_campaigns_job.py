#!/usr/bin/env python3
"""
Campaigns: Generate advertising campaigns from job data
"""
...
def main():
    ...
    campaign_count = final_campaigns.count()
    print(f"✅ Final campaigns saved to {monthly_campaigns_path}. Total campaigns: {campaign_count}")
    spark.stop()
